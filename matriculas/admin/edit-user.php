...
?>
<h1 class="text-dark"><i class="fas fa-tools"></i>  Editar Información de Usuario<small class="text-warning"></small></h1>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group text-center">
		    <input name="userupdate" value="Actualizar Perfil" type="submit" class="btn btn-success">
	  	</div>
	 </form>
</div>
</div>