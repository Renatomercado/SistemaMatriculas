<?php 
  ...
  if (isset($_POST['updatestudent'])) {
	...
	$apellidomaterno = $_POST['apellidomaterno'];
  	...
  	$query = "UPDATE `student_info` SET `name`='$name',`apellido`='$apellido',`roll`='$roll',`class`='$class',`city`='$address',`pcontact`='$pcontact',`photo`='$photo', `nombre_apoderado`='$nombre_apoderado', `apellido_apoderado`='$apellido_apoderado', `apellidomaterno`='$apellidomaterno'  WHERE `id`= $id";
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<?php
		if (isset($id)) {
			$query = "SELECT `id`, `name` , `roll`, `class`, `city`, `pcontact`, `photo`, `datetime`, `apellido` , `nombre_apoderado`, `apellido_apoderado` , `apellidomaterno`  FROM `student_info` WHERE `id`=$id";
