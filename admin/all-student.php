    ...
    <?php 
      ...
      <tr>
        ...
        echo '<td>'.$i.'</td>
          ...
          <td>
            <a class="btn btn-xs btn-Success" href="index.php?page=editstudent&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
              <i class="fa fa-edit"></i></a>

             &nbsp; <a class="btn btn-xs btn-Success" onclick="javascript:confirmationDelete($(this));return false;" href="index.php?page=delete&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
...
{
   var conf = confirm('Estás seguro que deseas eliminar este Alumno??!!, esta opcion no se puede regresar ');
   if(conf)
