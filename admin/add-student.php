<?php 
  ...
  if (isset($_POST['addstudent'])) {
	...
	$correo = $_POST['correo'];
  	...
  	$query = "INSERT INTO `student_info`(`name`, `roll`, `class`, `city`, `pcontact`, `photo`, `apellido` , `nombre_apoderado`, `apellido_apoderado` , `apellidomaterno`,`alergia`, `emergencia`, `correo` ) VALUES ('$name', '$roll', '$class', '$address', '$pcontact','$photo', '$apellido', '$nombre_apoderado', '$apellido_apoderado', '$apellidomaterno','$alergia', '$emergencia' , '$correo' );";
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="">
				...
				<option value="Quinto">Sexto</option>
				<option value="Quinto">Septimo</option>
				<option value="Quinto">Octavo</option>
		    </select>
	  	</div>
		  <div class="form-group">
	  	...
	  	<div class="form-group">
		    <label for="pcontact">	Celular Apoderado</label>
		  ...
		  <div class="form-group">
		    ...
		    <input name="alergia" type="text" value="<?= isset($alergia)? $alergia: '' ; ?>" class="form-control" id="alergia" required="">
	  	</div>
		  <div class="form-group">
		    <label for="emergencia"> Contacto de Emergencia</label>
		    <input name="emergencia" type="text" class="form-control" id="emergencia" pattern="[0-9]{8}" value="<?= isset($emergencia)? $emergencia: '' ; ?>" placeholder="+56" required="">
	  	</div>
		  <div class="form-group">
